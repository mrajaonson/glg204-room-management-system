    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationConverter jwtAuthenticationConverter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/rooms/*").hasAnyRole(Role.MANAGER.name(), Role.ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/rooms").authenticated()
                        .requestMatchers(HttpMethod.GET, "/rooms/*").authenticated()
                        .requestMatchers(HttpMethod.GET, "/rooms/*/availabilities").authenticated()
                        .requestMatchers(HttpMethod.GET, "/rooms/*/equipments").authenticated()
